...
examSchema.statics.getExam = async function(date, departmentName, courseTitle) {
...
examSchema.statics.createExam = async function({ date, departmentName, courseTitle, courseCode, level, questions = [] }) {
